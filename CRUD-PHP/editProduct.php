...
$productid = mysqli_real_escape_string($conn, $_REQUEST['editProductid']);
//echo "Edit Product: $productid";

$sql = "SELECT product.ProductId,product.Name,product.TypeId,product.Price, product.Description FROM product  where ProductId=$productid";
                    ...
                    <div class='d-flex justify-content-center'>
                        <div class='card'>
                            <div class='card-header' style='background-color: orange'>
                                ...
                                <b style='color: white'>Edit Product </b>
                            </div>
                            <div class='card-body'>
                                <form action='' method='post' enctype='multipart/form-data'>
                                    ...
                                    <div class='form-floating mb-3'>
                                        ...
                                        <input type='text' class='form-control' name='productName' id='floatingInputProductName' placeholder='Name' value='<?php echo"$name"; ?>' required>
                                    </div>
                                    ...
                                    <div class='form-floating mb-3'>
                                        ...
                                        <input type='number' class='form-control' name='price' id='floatingInputPrice' placeholder='Price' value='<?php echo"$price"; ?>' required>
                                    </div>
                                    ...
                                    <div class='form-floating mb-3'>
                                        ...
                                        <textarea type='text' class='form-control' name='productDescription' id='floatingInputProductDescription' placeholder='Description'  required><?php echo"$description"; ?></textarea>
                                    </div>
                                    ...
                                    <button type='submit' name='submit' id='submit' class='btn btn-success' style='float: left'>Edit Product</button>
...
if ( isset( $_REQUEST['submit'] ) ) {
    ...
    $productid2 = $_REQUEST['pid'];

    $query = "UPDATE product SET Name='$productName',TypeId='$productType',Price='$productPrice', Description='$productDescription',PicURL='$new_name',UpdatedOn=SYSDATE(),UpdatedBy='$sessionUser' WHERE ProductId='$productid2'";
