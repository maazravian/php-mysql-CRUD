...
<?php
    ...
    $sql = "SELECT product.Name,type.TypeName,product.Price, product.Description, product.PicURL FROM product inner join type on product.TypeId=type.TypeId where IsActive=1";
